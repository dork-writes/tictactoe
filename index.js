...
let clearGrid = () =>
{
    ...
    let playAudio = new Audio('whoosh.mp3');
    playAudio.play();
}
...
let disableAllCall = (text, highlight) =>
{
    ...
    if (text === '✓')
    {
        turn[0].style.color = "rgb(40, 230, 30)";
    }
    
    else
    {
        turn[0].style.color = "rgb(232, 12, 41)"
    }
    ...
    if (highlight)
    {
        for (let i = 0; i < highlight.length; i++)
        {
            if (text === '✓')
            {
                arr[highlight[i]].style.backgroundColor = "rgb(40, 230, 30)";
            }
            
            else
            {
                arr[highlight[i]].style.backgroundColor = "rgb(232, 12, 41)";
    ...
    let playAudio = new Audio('end.mp3');
    playAudio.play();
}
...
let checkCombination = () =>
{
    ...
    let playAudio = new Audio('move.mp3');
    playAudio.play();
}
